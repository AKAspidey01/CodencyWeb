...
import './Home.scss';
import checkOpen from '../../assets/images/aboutme-images/check-open.svg';
import { aboutData } from './AboutmeContent';
import basicPrice from '../../assets/images/aboutme-images/basic-price.svg';
import proPrice from '../../assets/images/aboutme-images/pro-price.svg';
import enterPrice from '../../assets/images/aboutme-images/enterprise.svg';
import checkCircle from '../../assets/images/aboutme-images/pricing-check.svg';
import whiteCheck from '../../assets/images/aboutme-images/white-check.svg';
import { Swiper, SwiperSlide } from 'swiper/react';
import faqThink from '../../assets/images/faq-think.svg';
...
import { aboutContactValidaion ,  aboutContactValidaion2} from '../../../utils/Validation/Validation';
import { useNavigate } from 'react-router-dom';
import axios from 'axios';
import toast from 'react-hot-toast';
import { config } from '../../../utils/Services/env-services';
import ResumePdf from './SaiGanesh_WebDeveloper_Resume.pdf';
...
import CvProfileBg from '../../assets/images/aboutme-images/download-cv-profile.jpg';
import ContactRight from '../../assets/images/aboutme-images/contact-right.jpg';
import BannerRight from '../../assets/images/aboutme-images/banner-about.jpg'
...
const Home = () => {
  ...
  const [visibleBottomer , setIsVisibleBottomer] = useState(false);
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const threshold = 500;
      setIsVisibleBottomer(scrollTop > threshold);
    };
  ...
  const aboutContactFormSubmit = async (data) => {
    const obj = {
    ...
    try {
     await axios.post(`${config.api}contact/createContact` , obj)
     .then((res) => {
      if(res) {
        console.log(res)
  ...
  return (
    <div className="AboutMe">
      <section>
        <div className="about-section-1">
          <div className="about-section-inner relative">
              <div className="grid grid-cols-2 gap-5 relative lg:gap-0">
                <div className="about-left-col py-10 lg:col-span-2 lg:order-2">
                  <div className="inner-left-sec pl-0 w-full max-w-[570px] xl:max-w-[510px] xl:pl-5 ml-auto lg:max-w-full lg:w-full">
                    <div className="about-me-head">
                      <h1 className='font-Manrope text-[50px] text-justify font-bold text-homeblack'>Hi, Im <span className='opacity-100 font-Poppins font-semibold'>Sai Ganesh</span> <br /> a Web Developer.</h1>
                    </div>
                    ...
                    <div className=" my-8 experince-blocker flex items-center gap-10 p-5">
                      <div className="flex items-center gap-3 about-years-sec">
                          <h2 className='text-5xl text-homeblack font-DmSans font-semibold'>5+</h2>
                    ...
                    <div className="banner-1-contact-sec flex items-center gap-10">
                      <div className="about-sec-1-button-1 w-[30%]">
                        <button type="button" onClick={scrolltoLast} className='group relative font-DmSans w-full text-white hover:text-homeblack duration-300 bg-homeblack py-3 text-lg font-semibold  border-none overflow-hidden'>
                      ...
                      <div className="about-sec-1-button-2 w-1/4">
                        <button type="button" onClick={homeNavigator} className='relative overflow-hidden font-DmSans group w-full text-homeblack hover:text-white duration-300 bg-greenYellow py-3 text-lg font-semibold  border-none'>
                ...
                <div className="about-right-col relative lg:col-span-2 lg:order-1">
                  <img src={BannerRight} className='w-full max-h-[550px] xl:max-h-full object-cover lg:max-h-[400px] lg:h-[400px]' alt="" />
                </div>
                {/* <div className="download-cvv-buttonsection absolute bottom-0 left-1/2 w-72 h-72 bg-white rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" className='w-full' xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 2300 1000" width="100%">
                    <defs>
        ...
        <div className="about-section-2 py-14 bg-homeblack">
          <div className="about-section-2-inner">
            <div className="container">
              <div className="grid grid-cols-3 gap-6 lg:grid-cols-2 main-aboutdev-cards-sec">
      ...
      <section ref={percentScroll}>
        <div className="about-section-3 py-14 bg-homeblack border-t border-white border-opacity-30" >
          <div className="about-section-3-inner">
            <div className="container">
                <div className="grid grid-cols-6 gap-5 hide-about-scrollanim-at-nineninety">
                  <div className="about-sec-3-left col-span-2">
                    <div className="about-3-image-sec rounded-[25px] bg-white  px-5 py-10">
                      <div className="top-about-3-left-img">
                        <img src={CvProfileBg} className='w-56 h-56 object-cover rounded-full mx-auto' alt="" />
                      </div>
                        ...
                        <div className="bottom-about-3-download-cv text-center mt-12" >
                          <button type="button" onClick={handleDownload} className='text-white bg-homeblack overflow-hidden relative group font-DmSans font-semibold rounded-full  w-44 h-12 text-center flex items-center justify-center mx-auto'>
                            ...
                            <div className="download-cv-icon absolute -top-6 left-1/2 group-hover:top-1 duration-500">
                              <i className="bi bi-arrow-down text-white text-xl"></i>
                            </div>
                    ...
                    <div className="right-inner-sec-3-about h-[48%] rounded-[25px] bg-white  p-7">
                      <div className="about-sec-3-head-right">
                        ...
                        <div className="bottom-desc-about-3 flex flex-col gap-3">
                          ...
                          <p className='font-Manrope'>Born and raised in India, When i'm not busy designing or developing websites , you'll likely find me playing games and watching Anime </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-6 gap-5 show-about-scrollanim-at-nineninety hide-about-scrollanim-at-sevensixty">
                  <div className="about-sec-3-left col-span-3">
                    <div className="about-3-image-sec rounded-[25px] bg-white  px-5 py-8">
                      <div className="top-about-3-left-img">
                        <img src={CvProfileBg} className='w-48 h-48 object-cover rounded-full mx-auto' alt="" />
                      </div>
                      <div className="about-3-bottom-text mt-6">
                        <div className="name-sec-about-3 text-center">
                          <h2 className='font-Manrope text-3xl font-bold text-homeblack'>Sai Ganesh</h2>
                  ...
                  <div className="about-sec-3-right col-span-3">
                    <div className="right-inner-sec-3-about rounded-[25px] h-full bg-white  p-7">
                      <div className="about-sec-3-head-right">
                        <h2 className='font-Manrope text-3xl font-bold text-homeblack'>Little More About Me</h2>
                        <div className="opento-work-about-3 flex items-center gap-2 mt-2 mb-3">
                          <div className="check-image">
                  ...
                  <div className="about-sec-3-bottom col-span-6">
                    <div className="right-inner-sec-3-about rounded-[25px] bg-white pt-6 pb-2 px-2 flex flex-col justify-between">
                      <div className="inner-bottom-percentager grid grid-cols-2 gap-3 px-4 pb-4">
                        <div className="about-3-top-side-skills-sec">
                          <div className="single-skill-percentage-sec-1 similar-skill-percent">
                            <div className="skill-head">
                ...
                <div className="grid grid-cols-6 gap-5 show-about-scrollanim-at-sevensixty">
                  <div className="about-sec-3-left col-span-6">
                    <div className="about-3-image-sec rounded-[25px] flex flex-col gap-5 bg-white px-5 py-6 relative">
                      <div className="bottom-about-3-download-cv text-center absolute top-5 right-5" >
                        <button type="button" onClick={handleDownload} className='text-white bg-homeblack overflow-hidden relative group font-DmSans font-semibold rounded-full  w-36 h-9 text-center flex items-center justify-center mx-auto'>
                          <div className="download-cv-p-outer group-hover:scale-0 duration-500 origin-center">
                            <p className=''>Download CV</p>
                          </div>
                          <div className="download-cv-icon absolute -top-6 left-1/2 group-hover:-top-1 duration-500">
                          ...
                          <div className="abs-down-baser absolute -bottom-6 left-1/2 w-5 h-[2px] rounded-full bg-white group-hover:bottom-3 duration-500"></div>
                        </button>
                      </div>
                      <div className="top-about-us-skills-merged-sec flex items-center gap-5">
                        <div className="top-about-3-left-img ">
                          <img src={CvProfileBg} className='w-28 h-28 object-cover rounded-full mx-auto' alt="" />
                        </div>
          ...
          <div className="about-seciton-4-inner">
              <div className="container">
                  ...
                  <div className="mywork-scrolling-blocks mt-5">
                     <div className="grid grid-cols-3 gap-8 mywork-scroll-inner-grid">
                            ...
                            <div className="single-work-blks-1 similar-work-blks shadow-2xl relative rounded-2xl group flex overflow-hidden" key={index}>
                                ...
                                <div className="work-after-section bg-darkgreen absolute top-1/2 left-1/2 rounded-full">
                                  <button type="button" className='w-16 h-16 rounded-full flex items-center justify-center' onClick={() => window.open(items.link)}>
                                    <i className="text-xl bi bi-arrow-up text-homeblack"></i>
                                  </button>
                                </div>
                            </div>
                          )
        ...
        <div className="about-seciton-5 py-16 bg-homeblack">
          <div className="about-section-5-inner">
            <div className="container">
              ...
              <div className="grid grid-cols-6 gap-8 mt-8 pricing-blocks-grid-section">
                <div className="single-pricing-about-block-1 col-span-2 bg-white similar-pricing-blocks-about p-6 rounded-[35px] shadow-cardsShadow">
                  <div className="inner-single-pricer-blk">
                      <div className="left-part-section-pricing">
                      ...
                      <div className="whats-included-sec-about-price">
                        ...
                        <div className="include-sec-list mt-4">
                          <ul className='flex flex-col gap-2 pricing-inner-list-flex-section'>
                        ...
                        <div className="bottom-price-button w-full mt-8">
                          <button type="button" className='w-full py-3 px-8 relative rounded-full text-left group bg-greenYellow text-homeblack font-DmSans font-bold text-xl'>
                            ...
                            <div className="btn-forwar-icon bg-homeblack absolute flex items-center justify-center right-0 top-0 w-1/4 h-full rounded-full group-hover:w-full duration-500">
                              <i className="bi bi-arrow-right text-2xl text-white group-hover:-rotate-45 delay-300 duration-500"></i>
                            </div>
                          </button>
                        </div>
                      </div>
                ...
                <div className="single-pricing-about-block-2 col-span-2 similar-pricing-blocks-about p-6 bg-greenYellow rounded-[30px] shadow-cardsShadow">
                  <div className="inner-single-pricer-blk">
                    <div className="top-pricing-about-sec flex items-center gap-4">
                      <div className="left-image-price-sec-about">
                ...
                <div className="single-pricing-about-block-3 col-span-2 bg-white similar-pricing-blocks-about p-6 rounded-[35px] shadow-cardsShadow">
                  <div className="inner-single-pricer-blk">
                    <div className="top-pricing-about-sec flex items-center gap-4">
                      <div className="left-image-price-sec-about">
              ...
              <div className="about-testimonial-heading flex items-center justify-between">
                ...
                <div className="right-buttons-section flex items-center gap-4">
                  <div className="review-swiper-button-prev">
                    <button className='w-10 h-10 rounded-full shadow-xl bg-purple flex items-center justify-center text-white'><i className="bi bi-arrow-left text-xl"></i></button>
                  </div>
                  <div className="review-swiper-button-next">
                    <button className='w-10 h-10 rounded-full shadow-xl bg-purple flex items-center justify-center text-white'><i className="bi bi-arrow-right text-xl"></i></button>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <AccordionSummary 
                          expandIcon={
                            <div className='expanded-outer w-7 h-7 flex items-center justify-center rounded-full bg-darkgreen'>
                              <i className="bi bi-chevron-down text-homeblack text-lg"></i>
                            </div>
                          } 
      ...
      <section ref={lastScroll}>
        <div className="about-section-8 py-16">
          <div className="about-section-8-inner">
            <div className="container">
              <div className="grid grid-cols-2 gap-8 hide-about-contact-ninety">
                <div className="left-side-contact-section shadow-cardsShadow px-8 rounded-3xl">
                 {successVisible ? 
                  <div className="successfull-form-submission py-10 h-full flex items-center justify-center">
                    <div className="inner-succeesfull">
                      <div className="success-message mb-4">
                        <h2 className='font-Manrope text-3xl font-bold text-center text-homeblack '>Details Submitted</h2>
                      </div>
                      <Lottie
                      ...
                      />
                      <div className="success-message mb-4 px-4">
                        <h2 className='font-DmSans text-xl font-medium text-center text-homeblack '>Your details have been successfully recorded. <br /> I will be in touch with you shortly</h2>
                      </div>
                    </div>
                  </div> :
                          ...
                          <Form>
                            <div className="top-firs-last-name grid grid-cols-2 gap-4">
                              ...
                              <div className="last-name-sec">
                                ...
                                <div className="form-inputsec">
                                  <Field type="tel" name="phoneNumber" placeholder='Phone Number' onKeyPress={(e) => numbersOnlyInput(e)}
                            ...
                            <div className="bottom-form-submitter w-1/2 mt-6 rounded-full overflow-hidden relative group new-form-submitting-sec">
                                <button type='submit' className={`w-full py-3 pr-4 rounded-full  bg-homeblack hover:bg-greenYellow duration-500 group flex items-center justify-center gap-4 ${submitLoader ? 'pl-2' : 'pl-4'}`}>
                                    {submitLoader ? 
                                    ...
                                    null}
                                  <p className='font-semibold  group-hover:text-black font-DmSans text-white text-lg duration-500'>{submitLoader ? 'Loading' : 'Submit'}</p>
                                </button>
                            </div>
                          </Form>
                        )}
                ...
                <div className="right-side-contant-section h-full flex flex-col gap-8 justify-between">
                    <div className="top-half-block-contact  w-full shadow-cardsShadow rounded-3xl overflow-hidden">
                        <img src={ContactRight} className='w-full h-[420px] object-cover' alt="" />
                    </div>
                        ...
                        <div className="bottom-three-blocks-addresses flex flex-col gap-5">
                          <div className="email-add-section flex items-center gap-4">
                            <div className="email-ico-blk bg-darkgreen bg-opacity-25 rounded-full w-16 h-16 flex items-center justify-center">
                              <i className="bi bi-envelope-at text-homeblack  text-2xl"></i>
                            </div>
                          ...
                          <div className="email-add-section flex items-center gap-4">
                            <div className="email-ico-blk bg-darkgreen bg-opacity-25 rounded-full w-16 h-16 flex items-center justify-center">
                              <i className="bi bi-telephone text-homeblack text-2xl"></i>
                            </div>
                            <div className="email-para-blk">
                          ...
                          <div className="email-add-section flex items-center gap-4">
                            <div className="email-ico-blk bg-darkgreen bg-opacity-25 rounded-full w-16 h-16 flex items-center justify-center">
                              <i className="bi bi-buildings text-homeblack text-2xl"></i>
                            </div>
                            <div className="email-para-blk">
                              <h4 className='font-Manrope '>Address</h4>
                              <p className='font-DmSans text-homeblack text-2xl'>Andhra Pradesh , India</p>
                            </div>
                          </div>
                        </div>
                    </div>
              ...
              <div className="grid grid-cols-2 gap-8 show-about-contact-ninety">
                <div className="top-half-block-contact w-full shadow-cardsShadow rounded-3xl overflow-hidden relative">
                  <img src={ContactRight} className='w-full h-full object-cover' alt="" />
                  <div className="contact-merged-with-image-section absolute bottom-0 w-full ">
                      <div className="bottom-half-block-contact w-full shadow-cardsShadow  bg-white p-8">
                          <div className="bottom-three-blocks-addresses flex flex-col gap-8">
                              <div className="email-para-blk">
                              ...
                              <div className="email-para-blk">
                                <div className="icon-heading-lable-contact mb-2 flex items-center gap-2">
                                  <i className="bi bi-buildings text-homeblack text-xl"></i>
                                  <h4 className='font-Manrope '>Address</h4>
                                </div>
                                <p className='font-DmSans text-homeblack text-2xl'>Andhra Pradesh , India</p>
                              </div>
                ...
                <div className="right-side-contant-section h-full flex flex-col gap-8 justify-between">
                    <div className="bottom-half-block-contact  w-full shadow-cardsShadow rounded-3xl h-full bg-white p-8">
                        <div className="bottom-three-blocks-addresses flex flex-col gap-8">
                            <div className="email-para-blk">
                              <div className="icon-heading-lable-contact mb-2 flex items-center gap-2">
                                <i className="bi bi-envelope-at text-homeblack  text-xl"></i>
                ...
                <div className="left-side-contact-section shadow-cardsShadow px-8 rounded-3xl col-span-2">
                  <div className="left-side-contact-inner  ">
                    {successVisible ? 
                      <div className="successfull-form-submission py-10 h-full flex items-center justify-center">
                        <div className="inner-succeesfull px-4">
                          <div className="success-message mb-4">
                            <h2 className='font-Manrope text-3xl font-bold text-center text-homeblack '>Details Submitted</h2>
                          </div>
                          <Lottie
                          ...
                          />
                          <div className="success-message mb-4 ">
                            <h2 className='font-DmSans text-base font-medium text-center text-homeblack '>Your details have been successfully recorded. I will be in touch with you shortly</h2>
                          </div>
                        </div>
                      </div> :
                      <div className="form-bottom-section-condition">
                        <div className="above-the-form-section-contact border-homeblack border-opacity-20 border-b pt-6 pb-6">
                          <div className="top-get-intouch-head mt-5 mb-3">
                            <h2 className="text-6xl font-DmSans leading-[70px] text-homeblack font-medium"><span>Let's Chat</span>, Reach Out to Me</h2>
                          </div>
                        ...
                        <div className="below-form-section-contact pt-6 pb-8">
                          <Formik
                            validationSchema={aboutContactValidaion2}
                            initialValues={aboutContactValues}
                            onSubmit={(values) => aboutContactFormSubmit(values)}
                          >
                            {({  errors, touched }) => (
                              <Form>
                                ...
                                <div className="bottom-form-submitter w-1/2 mt-6 rounded-full overflow-hidden relative group new-form-submitting-sec">
                                    <button type='submit' className={`w-full py-2 pr-4 rounded-full  bg-homeblack hover:bg-greenYellow duration-500 group flex items-center justify-center gap-4 ${submitLoader ? 'pl-2' : 'pl-4'}`}>
                                        {submitLoader ? 
                                          <div className="ui-loader loader-blk">
                                              <svg viewBox="22 22 44 44" className="multiColor-loader">
                                                  <circle cx="44" cy="44" r="20.2" fill="none" stroke-width="3.6" className="loader-circle loader-circle-animation"></circle>
      ...
      <div className={`bottom-scroll-to-top-button fixed bottom-4 right-4 z-[9999] duration-500 ${visibleBottomer ? 'scale-100' : 'scale-0'}`}>
        <button type="button" className='w-10 h-10 rounded-full bg-darkgreen ' onClick={scrollToTop}>
